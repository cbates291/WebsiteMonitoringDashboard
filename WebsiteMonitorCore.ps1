                ...
                try
                    {
                     ...
                     {
                         $WebResult += $_ | Select @{name="Uri"; expression={$uri}}, @{name="StatusCode"; expression={$_.Exception.Response.StatusCode}}, @{name="StatusDescription"; expression={[string]$_.Exception.Response.ReasonPhrase}}
                     }              
            }
...
$Server = Start-UDDashboard -Port 1001 -Dashboard $MyDashboard -Name WebsiteMonitorCore
